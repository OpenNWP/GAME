...
latlon_output_switch=0 # If set to 1, output will be written to netcdf files on a lat-lon grid.
hex_output_switch=1 # If set to 1, output will be written to netcdf files on the hexagonal (and pentagonal) cell centers.
