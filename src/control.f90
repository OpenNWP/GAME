...
program control
  ...
  allocate(grid%adjacent_edges(n_cells,6))
  allocate(grid%adjacent_signs(n_cells,6))
  ...
  allocate(state_1%rho(n_scalars,n_constituents))
  ...
  allocate(state_2%rho(n_scalars,n_constituents))
  ...
  allocate(state_tend%rho(n_scalars,n_constituents))
  ...
  allocate(diag%scalar_placeholder(n_scalars))
  ...
  allocate(state_write%rho(n_scalars,n_constituents))
