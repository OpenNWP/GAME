...
disp_shortname_list=(
t2 gusts10 rprate sprate tcc sst
...
$plot_interval_min $plot_interval_min $plot_interval_min $plot_interval_min $plot_interval_min 0
...
scope_list=(
CEU CEU CEU CEU CEU WORLD
) # the areas of the plots
projections_list=(
Gnomonic Gnomonic Gnomonic Gnomonic Gnomonic EckertIII
